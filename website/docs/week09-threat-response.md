---
sidebar_position: 9
sidebar_label: "Week 9: Body Alarm Timeline"
title: "Week 9: Body Alarm Timeline"
description: "Students use a fictional illness story to learn how body responses like fever and swelling can be both symptoms and part of the body's response."
---
...
- [Guided Session 1: A Character Catches a Cold](#guided-session-1)
- [Guided Session 2: When to Get Adult Help](#guided-session-2)
...
| **Materials** | Paper, pencils, timeline or comic boxes, Body Clues Notebook |
| **Key vocabulary** | symptom, body response, message signals, fever, swelling |
...
The learner can say that fever and swelling are clues you can feel and part of the body response story.
:::
