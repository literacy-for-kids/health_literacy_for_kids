---
sidebar_position: 20
sidebar_label: "Optional Week 2: Deeper Dive: Stress and Recovery"
title: "Optional Week 2: Deeper Dive: Stress and Recovery"
description: "An optional advanced lesson on the body's alert systems, recovery systems, and the cost of staying in alert mode too long."
---
...
:::warning Emotional Safety Reminder
...
- [Guided Session 1: Fast Alert Mode and Slower Hormone Support](#guided-session-1)
- [Guided Session 2: Recovery and the Cost of Staying On](#guided-session-2)
...
The learner can say that alert mode is useful and recovery matters too.
:::
...
1. Can the learner explain the difference between fast alert mode and slower hormone support?
2. Can the learner say why recovery matters?
3. Can the learner explain that this lesson is about understanding systems, not blaming people?
